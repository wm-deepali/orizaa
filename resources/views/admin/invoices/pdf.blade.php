                ...
                <tbody>
                    <tr>
                        <td class="header-logo-cell">
                            <img src="{{ public_path('orizaa-logo.webp') }}" style="height:120px; width:auto;">
                        </td>
     ...
     width="160" height="160">
        ...
        <div class="terms">
            ...
            <ol>
                ...
                <li>If you do not object to this invoice within 3 days, it will be presumed that you have accepted the
                    invoice.</li>
