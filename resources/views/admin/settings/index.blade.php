                            ...
                            <div class="tab-content">
                                    ...
                                    <form id="gstForm" method="POST" action="{{ route('admin.settings.update') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="igst"
                                                value="{{ $settings['igst'] ?? 18 }}" class="form-control">
                                        </div>

                                        <div class="form-group mt-3">
                                            <label>CGST (%)</label>
                                            <input type="number" step="0.01" name="cgst"
                                                value="{{ $settings['cgst'] ?? 9 }}" class="form-control">
                                        </div>

                                        <div class="form-group mt-3">
                                            <label>SGST (%)</label>
                                            <input type="number" step="0.01" name="sgst"
                                                value="{{ $settings['sgst'] ?? 9 }}" class="form-control">
                                        </div>
                                    ...
                                    <form id="invoiceForm" method="POST" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="invoice_prefix"
                                                value="{{ $settings['invoice_prefix'] ?? 'INV' }}" class="form-control">
                                        </div>

                                        <div class="form-group mt-3">
                                            <label>Serial Number</label>
                                            <input type="number" name="invoice_serial"
                                                value="{{ $settings['invoice_serial'] ?? 1001 }}" class="form-control">
                                        </div>

                                        <div class="form-group mt-3">
                                            <label>Billing Address</label>
                                            <textarea name="billing_address"
                                                class="form-control">{{ $settings['billing_address'] ?? '' }}</textarea>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="social">
                                    ...
                                    <form method="POST" action="{{ route('admin.settings.update') }}">
                                        ...
                                        <button class="btn btn-primary mt-3">Save Social Links</button>
