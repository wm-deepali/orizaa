...
<section class="about-hero py-8 md:py-20">
    <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <h1 class="text-5xl md:text-6xl font-bold leading-tight text-gray-900 mb-6">
            About <span class="text-[#D4AF37]">Oriza</span><span class="text-[#B8962E]"> Style</span><span class="text-[#C9A227]"></span>
        </h1>
...
<section class="py-16 md:py-24 bg-white">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="brand-promise-card p-8 bg-white border border-gray-100 rounded-3xl hover:border-[#D4AF37] transition-all group">
                <div class="w-14 h-14 bg-[#D4AF37]/10 text-[#D4AF37] rounded-2xl flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                    ✨
                </div>
            ...
            <div class="brand-promise-card p-8 bg-white border border-gray-100 rounded-3xl hover:border-[#B8962E] transition-all group">
                <div class="w-14 h-14 bg-[#B8962E]/10 text-[#B8962E] rounded-2xl flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                    🎨
                </div>
            ...
            <div class="brand-promise-card p-8 bg-white border border-gray-100 rounded-3xl hover:border-[#C9A227] transition-all group">
                <div class="w-14 h-14 bg-[#C9A227]/10 text-[#C9A227] rounded-2xl flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                    🤝
                </div>
            ...
            <div class="grid md:grid-cols-2">
                ...
                <div class="p-4 md:p-16 flex flex-col justify-center">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-col gap-4">
                        <a href="#" class="px-8 py-4 bg-[#D4AF37] text-white text-center rounded-2xl font-semibold">For Corporates</a>
                        <a href="#" class="px-8 py-4 border border-gray-300 text-center hover:border-[#D4AF37] rounded-2xl font-semibold transition-colors">Explore Our Collection</a>
                    </div>
                </div>
            </div>
        </div>
