...
@section('content')
    ...
    <section
        ...
        <div
            class="absolute inset-0 bg-[radial-gradient(#D4AF37_0.8px,transparent_1px)] [background-size:40px_40px] opacity-10">
        </div>
 ...
 @endif
                            ...
                            <form method="GET" class="mt-12">
                                ...
                                <h3 class="font-semibold text-lg mb-5 text-gray-800">Shop by Filters</h3>
                                ...
                                <div class="mb-8">
                                    <h4 class="font-medium mb-3">Customization Options</h4>
                                ...
                                <!-- Gifting Occasions Mobile-->
                                  @if($occasions->count() > 0)
                                <div class="mb-8">
                                    <h4 class="font-medium mb-4">Gifting Occasion</h4>
                                    ...
                                    <div class="flex flex-col gap-3">
                                        @foreach($occasions as $occ)
                                                    <label class="block w-full">
                                                        ...
                                                        <span class="block w-full px-5 py-4 rounded-xl 
                                             bg-pink-50 text-gray-700 border border-transparent
                                             cursor-pointer transition" onclick="this.classList.toggle('bg-pink-100'); 
                                ...
                                <!-- Delivery -->
                                <div class="mb-8">
                                    <h4 class="font-medium mb-3">Delivery Options</h4>
                                    <label class="flex items-center gap-2 mb-2">
                                ...
                                <!-- Special -->
                                <div>
                                    <h4 class="font-medium mb-3">Shop by Collection</h4>
                                    <label class="flex items-center gap-2 mb-2">
                                    ...
                                    <div>
                                        ...
                                        <label class="flex items-center gap-2 mb-2">
                                            <input type="checkbox" class="accent-[#D4AF37]" name="best_seller" value="1" {{ request('best_seller') ? 'checked' : '' }}>
                                            Best Sellers
                                        </label>
                                        <label class="flex items-center gap-2 mb-2">
                                            <input type="checkbox" class="accent-[#D4AF37]" name="sale" value="1" {{ request('sale') ? 'checked' : '' }}>
                                            Exclusive On Sale
                                        </label>
                                        <label class="flex items-center gap-2 mb-2">
                                            <input type="checkbox" class="accent-[#D4AF37]" name="is_premium" value="1" {{ request('is_premium') ? 'checked' : '' }}>
                                            Premium Collections
                                        </label>
                                        <input type="checkbox" class="accent-[#D4AF37]" name="bulk_available" value="1" {{ request('bulk_available') ? 'checked' : '' }}>
                                        For Bulk Orders
                                        </label>
                                        <label class="flex items-center gap-2 mb-2">
                                            <input type="checkbox" class="accent-[#D4AF37]" name="is_engraving" value="1" {{ request('is_engraving') ? 'checked' : '' }}>
                                            Bespoke Creation
                                        </label>
                                        <label class="flex items-center gap-2 mb-2">
                                            <input type="checkbox" class="accent-[#D4AF37]" name="is_personalized_engraving"
                                                value="1" {{ request('is_personalized_engraving') ? 'checked' : '' }}>
                                            Signature Collection
                                        </label>
                                        <label class="flex items-center gap-2 ">
                                            <input type="checkbox" class="accent-[#D4AF37]" name="is_limited_edition"
                                                value="1" {{ request('is_limited_edition') ? 'checked' : '' }}>
                                            Limited Edition
                                        </label>
                                        <label class="flex items-center gap-2 mb-2">
                                            <input type="checkbox" class="accent-[#D4AF37]" name="gift_hamper" value="1" {{ request('gift_hamper') ? 'checked' : '' }}>
                                            Gift Hampers
                                        </label>
                                        <label class="flex items-center gap-2 mb-2">
                ...
                <div class="sidebar-card lg:block hidden">
                    ...
                    <form method="GET" class="mt-12">
                                ...
                                @foreach($occasions as $occ)
                                    <label class="block w-full">
                                        ...
                                        <span class="block w-full px-5 py-4 rounded-xl 
                                                                             ...
                                                                             cursor-pointer transition" style="background-color: #f8f4f0;"
                        ...
                        <!-- Delivery -->
                        <div class="mb-8">
                            <h4 class="font-medium mb-3">Delivery Option</h4>
                            <label class="flex items-center gap-2 mb-2">
                                <input type="checkbox" class="accent-[#D4AF37]" name="pan_india" value="1" {{ request('pan_india') ? 'checked' : '' }}>
                                Pan India Delivery
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="ready_to_ship" value="1" {{ request('ready_to_ship') ? 'checked' : '' }}>Ready to Deliver
                            </label>
                        </div>
                        ...
                        <div>
                            ...
                            <label class="flex items-center gap-2 mb-2">
                                <input type="checkbox" class="accent-[#D4AF37]" name="is_personalized_engraving" value="1"
                                    {{ request('is_personalized_engraving') ? 'checked' : '' }}>
                                Signature Collection
                            </label>
                            <label class="flex items-center gap-2 mb-2">
                                <input type="checkbox" class="accent-[#D4AF37]" name="is_limited_edition" value="1" {{ request('is_limited_edition') ? 'checked' : '' }}>
                                Limited Edition
                            </label>
